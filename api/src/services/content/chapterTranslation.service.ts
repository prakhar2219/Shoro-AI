...
export const updateChapterTranslation = async (slug: string, data: Partial<IChapterTranslation>) => {
    return await ChapterTranslation.findOneAndUpdate({ slug }, data, { new: true });
};
