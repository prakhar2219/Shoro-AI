...
// Compound unique index: order must be unique within each GB subtopic and language
GBQuestionSchema.index({ gb_subtopic_id: 1, language_id: 1, order: 1 }, { unique: true });
