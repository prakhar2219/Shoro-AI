...
export const createBlog = async (req: Request, res: Response): Promise<void> => {
    try {
        const { title, slug, content, mainImage, keywords, excerpt, author, categories, published
        } = req.body;
...
export const updateBlog = async (req: Request, res: Response): Promise<void> => {
    try {
        const { title, slug, content, mainImage, keywords, excerpt, author, categories, published } = req.body;
