...
export const createSubtopic = async (req: Request, res: Response) => {
  const { topic_id, language_id, title, slug, order, is_published, created_by, content, tag, source, author, flashcards, mock_test, total_questions, total_time, pass_questions } = req.body;
