...
import { uploadImageToCloudinary, uploadImageFromFormBuffer } from '../services/upload.service';
...
interface MulterBufferRequest extends Request {
  ...
  export const uploadImageForm = async (req: MulterBufferRequest, res: Response): Promise<void> => {
    try {
