...
export default function ShortQuestionsPage() {
  ...
  const handleBulkUpload = async (rows: any[]) => {
    try {
      startLoading();
      // transform rows similar to MCQ csv transform; then bulkCreateShortQuestions
    ...
    >
      ...
      <CsvUploadDialog
        schema={{
          ...
          description: 'Columns: entity_type, entity_id, supported_language_ids, question, option_a..d, correct_answer, explanation, difficulty, tags, is_active, content',
