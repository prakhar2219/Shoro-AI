...
export default function EditBoardTranslationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    // await updateBoardTranslation(params.translationId, translation);
    setLoading(false);
  ...
  return (
    <div className="p-6 max-w-xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Edit Board Translation</h1>
