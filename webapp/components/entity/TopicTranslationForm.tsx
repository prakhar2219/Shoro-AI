...
interface TopicTranslationFormProps {
  initialData?: any;
...
export function TopicTranslationForm({ initialData, onSubmit, loading = false, languages }: TopicTranslationFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={form.slug}
              onChange={handleChange}
              placeholder="topic-title-translation"
            />
          </div>
          <div className="space-y-2">
