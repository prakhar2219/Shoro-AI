...
interface GBSubtopicTranslationFormProps {
  initialData?: any;
...
export function GBSubtopicTranslationForm({ initialData, onSubmit, loading = false, languages }: GBSubtopicTranslationFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={form.slug}
              onChange={handleChange}
              placeholder="gb-subtopic-name-translation"
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={handleChange}
              placeholder="Brief description of the GB subtopic"
            />
          </div>
          <div className="space-y-2">
