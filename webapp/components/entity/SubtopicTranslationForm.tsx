...
interface SubtopicTranslationFormProps {
  initialData?: any;
...
export function SubtopicTranslationForm({ initialData, onSubmit, loading = false, languages }: SubtopicTranslationFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={form.slug}
              onChange={handleChange}
              placeholder="subtopic-title-translation"
            />
          </div>
          <div className="space-y-2">
