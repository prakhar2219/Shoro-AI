...
export function GBTopicTranslationForm({ initialData, onSubmit, loading = false, languages }: GBTopicTranslationFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={form.slug}
              onChange={handleChange}
              placeholder="gb-topic-name-translation"
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={handleChange}
              placeholder="Brief description of the GB topic"
            />
          </div>
          <div className="space-y-2">
