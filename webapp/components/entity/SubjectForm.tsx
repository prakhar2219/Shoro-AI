  ...
  useEffect(() => {
    if (initialData) {
      ...
      setForm(f => ({
        ...
        flashcards: initialData.flashcards ?? f.flashcards,
        mock_test: initialData.mock_test ?? f.mock_test,
        total_questions: initialData.total_questions ?? f.total_questions,
        total_time: initialData.total_time ?? f.total_time,
        pass_questions: initialData.pass_questions ?? f.pass_questions,
      }));
