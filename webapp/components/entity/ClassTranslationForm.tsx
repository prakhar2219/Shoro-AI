...
interface ClassTranslationFormProps {
...
export function ClassTranslationForm({ onSubmit, loading = false, initialData, languages }: ClassTranslationFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Enter class name in selected language"
              required
            />
          </div>
